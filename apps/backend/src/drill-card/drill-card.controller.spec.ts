...
describe('CardController', () => {
  ...
  beforeAll(async () => {
    ...
    testDrillCard = testData.drillCards.find((dc) => dc.gameId === testData.game.id)!
  });
  ...
  describe('GET /drill-card', () => {
    it('should return a 200 and all the drillCards', async () => {
        ...
        expect(response.body.length).toBeGreaterThanOrEqual(testData.drillCards.length)
    })
  })
