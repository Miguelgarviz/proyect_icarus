...
describe('LobbyController', () => {
  ...
  describe('POST /lobby', () =>{
    it('should return a 201 and create the lobby correctly', async () => {
        ...
        const createdLobby = await prisma.lobby.findUniqueOrThrow({where: { id: response.body.id } })
  ...
  describe('PUT /lobby/:id', () => {
    it('should return a 200 and update the lobby', async () => {
        ...
        const updatedLobby = await prisma.lobby.findUniqueOrThrow({where: { id: response.body.id } })
